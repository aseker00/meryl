...
class TagRNN4(nn.Module):
    ...
    def forward(self, token_seq: torch.Tensor, seq_lengths: torch.Tensor, gold_morph_seq: torch.Tensor):
        ...
        preds = torch.stack([gold_pref_forms, pred_pref_tags, gold_pref_feats, gold_host_forms, pred_host_tags, gold_host_feats, gold_suff_forms, pred_suff_tags, gold_suff_feats], dim=0)
        ...
        losses = torch.stack([pref_tag_loss, host_tag_loss, suff_tag_loss])
