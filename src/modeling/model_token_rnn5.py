...
class TagRNN5(nn.Module):
    ...
    def forward(self, token_seq: torch.Tensor, seq_lengths: torch.Tensor, gold_morph_seq: torch.Tensor):
        ...
        preds = torch.stack([gold_pref_forms, gold_pref_tags, gold_pref_feats, gold_host_forms, gold_host_tags, pred_host_feats, gold_suff_forms, gold_suff_tags, gold_suff_feats], dim=0)
        ...
        losses = torch.stack([host_feats_loss])
